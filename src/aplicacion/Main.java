...
public class Main {
    public static void main(String[] args) {
        ...
        //System.out.println("La suma de los elementos de la lista " + list1 + " es: " + Mates.suma(list1));
        ...
        System.out.println("La suma de los números pares de 0 a "+ n + " es: " + Mates.recursiveEvenSumN(n));
        System.out.println("La suma de los números pares de la lista "+ list1 + " es: "
                                                        + Mates.recursiveEvenSumList(list1));
        System.out.println("Los números pares de la lista "+ list1 + " es: "
                                                        + Mates.recursiveEvenList(list1));
